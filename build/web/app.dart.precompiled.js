...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "ArrayBuffer|Blob|DOMError|DOMImplementation|File|FileError|IDBKeyRange|ImageData|MediaError|MediaKeyError|MutationObserver|MutationRecord|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedEnumeration|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString|WebKitMutationObserver"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["core_elements.paper_menu_button", "package:paper_elements/paper_menu_button.dart", , U, {
  "^": "",
  PaperMenuButton: {
...
["dart.async", "dart:async", , P, {
  ...
  _AsyncCompleter: {
    ...
    }, "completeError$1", "call$2", "call$1", "get$completeError", 2, 2, 36, 17, 18, 19]
  },
  _Future: {
  ...
  _rootHandleUncaughtError__closure: {
    "^": "Closure:26;error_2,stackTrace_3",
    call$0: function() {
      var t1, trace;
      t1 = this.error_2;
...
["dart.collection", "dart:collection", , P, {
  ...
  _defaultEquals: [function(a, b) {
    return J.$eq(a, b);
  }, "call$2", "_defaultEquals$closure", 4, 0, 20, 21, 22],
  _defaultHashCode: [function(a) {
    return J.get$hashCode$(a);
  }, "call$1", "_defaultHashCode$closure", 2, 0, 23, 21],
...
["polymer", "package:polymer/polymer.dart", , A, {
  "^": "",
  PolymerElement: {
    "^": "HtmlElement_Polymer_ChangeNotifier;change_notifier$ChangeNotifier$_changes,change_notifier$ChangeNotifier$_records,polymer$Polymer$_polymer$_element,polymer$Polymer$_namedObservers,polymer$Polymer$_observers,polymer$Polymer$_unbound,polymer$Polymer$_unbindAllJob,polymer$Polymer$_propertyObserver,polymer$Polymer$_readied,polymer$Polymer$_jsElem,polymer$Polymer$_hasBeenAttached,polymer$Polymer$shadowRoots,polymer$Polymer$$"
  },
  HtmlElement_Polymer: {
    "^": "HtmlElement+Polymer;"
  },
...
["yrs2014", "app.dart", , E, {
  ...
  main: [function() {
    var t1 = H.setRuntimeTypeInfo(new W._EventStream(window, C.EventStreamProvider_click._eventType, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new E.main_closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = H.setRuntimeTypeInfo(new W._EventStream(window, C.EventStreamProvider_keydown._eventType, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new E.main_closure0()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = E.sources();
    t1.then$1(new E.main_closure1());
    t1.catchError$1(new E.main_closure2());
  ...
  main_closure: {
    ...
    call$1: [function(e) {
      ...
      t2 = t1.get$client(e);
      t2 = "Clickety click at " + H.S(t2.get$x(t2)) + ",";
      t1 = t1.get$client(e);
      P.print(t2 + H.S(t1.get$y(t1)));
    }, "call$1", null, 2, 0, null, 1, "call"]
  },
  main_closure0: {
    "^": "Closure:52;",
  ...
  main_closure1: {
    "^": "Closure:28;",
    call$1: [function(map) {
      var t1, value, t2, line;
      P.print("Available sources");
      for (H.interceptedTypeCast(map, "$isMap"), t1 = J.get$iterator$ax(map.get$values(map)); t1.moveNext$0();) {
        value = t1.get$current();
        t2 = J.getInterceptor$asx(value);
        line = H.S(t2.$index(value, "namePretty")) + ": " + H.S(t2.$index(value, "index"));
        H.printString(line);
      }
...
C.Type_IIj = H.createRuntimeType('PaperMenuButton');
...
function dart_precompiled($collectedClasses) {
  ...
  function CoreIconButton(common$DomProxyMixin$_proxy) {
    this.common$DomProxyMixin$_proxy = common$DomProxyMixin$_proxy;
  }
  CoreIconButton.builtin$cls = "CoreIconButton";
  if (!"name" in CoreIconButton)
    CoreIconButton.name = "CoreIconButton";
  $desc = $collectedClasses.CoreIconButton;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CoreIconButton.prototype = $desc;
  ...
  function CoreToolbar(common$DomProxyMixin$_proxy) {
    this.common$DomProxyMixin$_proxy = common$DomProxyMixin$_proxy;
  }
  CoreToolbar.builtin$cls = "CoreToolbar";
  if (!"name" in CoreToolbar)
    CoreToolbar.name = "CoreToolbar";
  $desc = $collectedClasses.CoreToolbar;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CoreToolbar.prototype = $desc;
  ...
  function PaperItem(common$DomProxyMixin$_proxy) {
    this.common$DomProxyMixin$_proxy = common$DomProxyMixin$_proxy;
  }
  PaperItem.builtin$cls = "PaperItem";
  if (!"name" in PaperItem)
    PaperItem.name = "PaperItem";
  $desc = $collectedClasses.PaperItem;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PaperItem.prototype = $desc;
  ...
  function PaperMenuButton(common$DomProxyMixin$_proxy) {
    this.common$DomProxyMixin$_proxy = common$DomProxyMixin$_proxy;
  }
  PaperMenuButton.builtin$cls = "PaperMenuButton";
  if (!"name" in PaperMenuButton)
    PaperMenuButton.name = "PaperMenuButton";
  $desc = $collectedClasses.PaperMenuButton;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PaperMenuButton.prototype = $desc;
  ...
  function PolymerElement(change_notifier$ChangeNotifier$_changes, change_notifier$ChangeNotifier$_records, polymer$Polymer$_polymer$_element, polymer$Polymer$_namedObservers, polymer$Polymer$_observers, polymer$Polymer$_unbound, polymer$Polymer$_unbindAllJob, polymer$Polymer$_propertyObserver, polymer$Polymer$_readied, polymer$Polymer$_jsElem, polymer$Polymer$_hasBeenAttached, polymer$Polymer$shadowRoots, polymer$Polymer$$) {
  ...
  function sources_closure(comp_0) {
    this.comp_0 = comp_0;
  }
  sources_closure.builtin$cls = "sources_closure";
  if (!"name" in sources_closure)
    sources_closure.name = "sources_closure";
  $desc = $collectedClasses.sources_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  sources_closure.prototype = $desc;
  function sources_closure0(comp_1) {
    this.comp_1 = comp_1;
  }
  sources_closure0.builtin$cls = "sources_closure0";
  if (!"name" in sources_closure0)
    sources_closure0.name = "sources_closure0";
  $desc = $collectedClasses.sources_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  sources_closure0.prototype = $desc;
  ...
  function doKonami_closure() {
  }
  doKonami_closure.builtin$cls = "doKonami_closure";
  if (!"name" in doKonami_closure)
    doKonami_closure.name = "doKonami_closure";
  $desc = $collectedClasses.doKonami_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  doKonami_closure.prototype = $desc;
  function SourceSelectionElement(imgsrc, change_notifier$ChangeNotifier$_changes, change_notifier$ChangeNotifier$_records, polymer$Polymer$_polymer$_element, polymer$Polymer$_namedObservers, polymer$Polymer$_observers, polymer$Polymer$_unbound, polymer$Polymer$_unbindAllJob, polymer$Polymer$_propertyObserver, polymer$Polymer$_readied, polymer$Polymer$_jsElem, polymer$Polymer$_hasBeenAttached, polymer$Polymer$shadowRoots, polymer$Polymer$$) {
    this.imgsrc = imgsrc;
    this.change_notifier$ChangeNotifier$_changes = change_notifier$ChangeNotifier$_changes;
    this.change_notifier$ChangeNotifier$_records = change_notifier$ChangeNotifier$_records;
    this.polymer$Polymer$_polymer$_element = polymer$Polymer$_polymer$_element;
